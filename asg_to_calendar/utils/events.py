...
# ::IMPORTS ------------------------------------------------------------------------ #
from asg_to_calendar.logger import logger as log

from datetime import datetime, timezone

from asg_to_calendar.settings import CREDS, SCOPES, SERVICE_NAME, SERVICE_VERSION, CSV_FIELDS, EVENT_MAP
from asg_to_calendar.settings import FILE_MAP, COMMANDS, STRFTIME_COLS, STRFTIME_ROWS, PROMPTS, EVENTS_OUTFILE
...
class Events:
    ...
    def get_delete_data(self) -> list[str]:
        '''
    ...
    def import_csv(self, csv_file) -> pd.DataFrame:
        '''
